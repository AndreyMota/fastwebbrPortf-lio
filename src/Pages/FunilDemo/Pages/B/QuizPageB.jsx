...
const QuizB = () => {
  ...
  const questions = [
    ...
    {
        title: "Você acredita que sua aparência ou atitude influenciam na forma como as mulheres te veem?",
        options: [
          ["Sim, acho que poderia melhorar minha aparência ou atitude", 1],
          ["Talvez, mas não tenho certeza do que precisaria mudar", 2],
          ["Não, estou confiante em como me apresento e minha atitude", 3]
        ],
        image: autoimagem,
      },
    {
    ...
    {
        title: "Descubra seu perfil único agora",
        options: [
          ["Me mostre meu resultado", 1],
          ["Diga qual é o meu perfil", 1],
          ["Mostre-me como posso melhorar", 1]
        ],
    },
    {
  ...
  const handleOptionClick = (option, optionScore) => {
    ...
    if (step < questions.length - 2) {
      ...
      navigate("DescubraOSeuPotencial");
    }
  };
